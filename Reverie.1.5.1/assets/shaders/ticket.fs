...
vec4 effect( vec4 colour, Image texture, vec2 texture_coords, vec2 screen_coords )
{
    ...
    if (uv.y <= 0.375 && omit_top_half > 0.0){
        tex.a = 0.;
    } else if (uv.y > 0.375 && omit_bottom_half > 0.0) {
        tex.a = 0.;
    }
        ...
        any(greaterThan(abs(tex.rgb - joker_black.rgb), vec3(0.1))))
    {
        ...
        tex.r = orig_rgba.r * (1.0 - tex.a) + tex.r * tex.a;
        tex.g = orig_rgba.g * (1.0 - tex.a) + tex.g * tex.a;
        tex.b = orig_rgba.b * (1.0 - tex.a) + tex.b * tex.a;
        tex.a = orig_rgba.a;
