...
vec4 effect( vec4 colour, Image texture, vec2 texture_coords, vec2 screen_coords )
{
    ...
    rgb.r = rgb.r * (0.0 + floor(mod2(cx / 9.0 + 0.0000) + 0.3333));
    rgb.g = rgb.g * (0.0 + 0.7 * floor(mod2(cx / 9.0 + 0.3333) + 0.3333));
    rgb.b = rgb.b * (0.0 + floor(mod2(cx / 9.0 + 0.6667) + 0.3333));
    ...
    //hsl.x = floor(cx/3)/3;
    //hsl.z = (3 + hsl.z)/5;
    hsl.z -= max(0.0, pow(sin(6.28 * mod2(cx / 9.0 + 0.25)), 4.0) - 0.2);
    hsl.z -= max(0.0, pow(sin(6.28 * mod2(cy / 9.0 + 0.25)), 4.0) - 0.2);
    hsl.z = max(hsl.z, 0.0);
    ...
    float res = (0.5 + 0.5 * cos( (lowres.x) * 2.612 + ( field - 0.5 ) * 3.14 ));
    vec4 textp = RGB(hsl);
    tex.rgb = textp.rgb;
